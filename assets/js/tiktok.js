...
! function(e) {
    ...
    var n = "https://dash.elfsight.com",
        i = function(e) {
            ...
            t.initWidget = function(n, r) {
                if (i) {
                    ...
                    var a = {
                        ...
                        showElfsightLogo: false, // Oculta la marca de agua
                        owner: r.isOwner,
                        platform: r.platform,
                        displayFreeLink: false, // Desactiva el enlace gratuito
                        displayFreeLinkRemove: false, // Desactiva la opción para eliminar el enlace gratuito
                        displayDeactivation: false, // Desactiva el mensaje de desactivación
                    };

                    // Procesa configuraciones adicionales de atributo
                    var s = t.getAttributeSettings(n);
                    ...
                    // Inicializa el widget con las configuraciones
            ...
            // Evita inicializar la barra de herramientas para eliminar las marcas de agua visibles
            t.initToolbar = function() {
                // No se ejecuta nada aquí
            };

            // Inicializa widgets almacenados en el buffer
            ...
            // Función auxiliar para obtener configuraciones de atributos personalizados
